...
var resizePizzas = function(size) {
    ...
    function changeSliderLabel(size) {
        //Move outside the loop and getElementById is more efficient to access DOM than querySelector
    ...
    //Changes the pizzas' width to a percentage format
    function changePizzaSizes(size) {
        ...
        //Move outside the loop and getElementsByClassName is more efficient to access DOM than querySelectorAll
...
//More efficient to access DOM than document.querySelectorAll('.mover')
var items = document.getElementsByClassName('mover');

function updatePositions() {
    frame++;
    window.performance.mark("mark_start_frame");
    //Just store 5 numbers and use those numbers to change the position of these elements
    var phase = [];
    for (var i = 0; i < 5; i++) {
        phase[i] = 100 * Math.sin(scrollTop / 1250 + i);
    }

    for (var i = 0, len = items.length; i < len; i++) {
        //use some sort of CSS3 hardware acceleration here because CSS3 has hardware acceleration and certain transformations that reduce the
        //need to retrigger a read layout.so use transform:translateX() instead of style.left to position your element
        //get rid of the need to trigger a read layout
...
//Make sure updatePositions function isn't firing unnecessarily.
...
document.addEventListener('DOMContentLoaded', function() {
    var cols = 8;
    var s = 256;
    //Get the number of pizzas according to the screen height
